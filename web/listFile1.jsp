                                        ...
                                        <c:choose>
                                            <c:when test="${file.isFile() == true}">
                                                <tr>
                                                    ...
                                                    <td><fmt:formatDate type = "both" dateStyle = "medium" timeStyle = "medium" value = "${file.getTimestamp().getTime()}"  /></td>
                                                    <td>  
                                                        ...
                                                        <a href="deleteServlet?fileName=${file.getName()}"><button>Delete File</button></a>
                                                    </td>
                                                </tr>
                                            </c:when>
